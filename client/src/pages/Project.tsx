                            ...
                            <div key={project.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition duration-300 group">
                                <div className="relative h-56 overflow-hidden">
                                    ...
                                    <div className="absolute top-4 left-4">
                                        <span className={`text-xs font-bold uppercase py-1 px-2 rounded-full ${project.category === 'education' ? 'bg-blue-500 text-white' :
                                ...
                                <div className="p-6">
                                    <div className="flex justify-between items-start mb-2">
                                        ...
                                        <span className={`text-xs font-medium py-1 px-2 rounded-full ${project.status === 'active' ? 'bg-green-100 text-green-800' :
